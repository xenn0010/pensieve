-- Simple intelligence cache tables for Supabase
...
CREATE TABLE IF NOT EXISTS intelligence_cache (
    ...
    company_domain TEXT,
    research_depth TEXT NOT NULL DEFAULT 'basic',
...
-- Table for intelligence access patterns
...
-- Simple function to get fresh intelligence
